...
namespace kahypar
{
  ...
  private:
    ...
    {
    public:
      VertexPairRating(HypernodeID trgt, RatingType val, bool is_valid) : target(trgt),
                                                                          value(val),
                                                                          valid(is_valid) {}

      VertexPairRating() : target(std::numeric_limits<HypernodeID>::max()),
  ...
  public:
    ...
    VertexPairRater(Hypergraph &hypergraph, const Context &context) : _hg(hypergraph),
                                                                      _context(context),
